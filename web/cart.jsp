		...
		<div class="container-list-product">
			<table class="cart-list">
				...
				<c:forEach var="i" items="${sessionScope.list_orders}"> 
					<tr>
						<td style="width: 17%"><a href="detail?id=${i.product.id}"><img style="width:100%;height:289px" src="img/products_img/${i.product.image}"></a></td>
			...
			<div class="cart-redirect-btn">
				...
				<button style="margin-left: 4px; background-color: #3dc8f6" onclick="window.location.href=''">Thanh toán</button>
			</div>
		</div>
